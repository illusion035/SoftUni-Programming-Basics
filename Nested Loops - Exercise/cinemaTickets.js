function cinemaTickets(input) {
    ...
    while (command !== "Finish") {
        ...
        let resultSingeFilm = ticketCounter / freeSpaces * 100;

        console.log(`${name} - ${resultSingeFilm.toFixed(2)}% full.`)
...
cinemaTickets(["The Matrix", "10", "standard", "kid", "student", "student", "standard", "standard", "End", "Scary Movie", "6", "student", "student", "student", "student", "student", "student", "Finish"])